...
export default function Navigation() {
  const fillSelected = "#D15439";
  const fillUnselected = "#B5B5B5";

  const opacitySelected = "1";
  const opacityUnselected = "0.5";

  const router = useRouter();

  return (
    <div className="fixed bottom-0 h-16 w-full flex flex-row justify-between items-center text-sm text-neutral-500">
      <button
      ...
      >
        ...
        >
          <path
            ...
            fill={router.pathname === "/page1" ? fillSelected : fillUnselected}
            fill-opacity={
              router.pathname === "/page1" ? opacitySelected : opacityUnselected
            }
          />
        </svg>
        <p
      ...
      >
        ...
        >
          <path
            ...
            fill={router.pathname === "/page2" ? fillSelected : fillUnselected}
            fill-opacity={
              router.pathname === "/page2" ? opacitySelected : opacityUnselected
            }
          />
        </svg>
        <p
      ...
      >
        ...
        >
          <path
            ...
            fill={router.pathname === "/page3" ? fillSelected : fillUnselected}
            fill-opacity={
              router.pathname === "/page3" ? opacitySelected : opacityUnselected
            }
          />
        </svg>
        <p
          className={
            router.pathname === "/page3"
              ? `text-[${fillSelected}]`
              : "text-neutral-500"
          }
        >
      ...
      >
        ...
        >
          <path
            ...
            fill={router.pathname === "/page4" ? fillSelected : fillUnselected}
            fill-opacity={
              router.pathname === "/page4" ? opacitySelected : opacityUnselected
            }
          />
        </svg>
        <p
          className={
            router.pathname === "/page4"
              ? `text-[${fillSelected}]`
              : "text-neutral-500"
          }
        >
